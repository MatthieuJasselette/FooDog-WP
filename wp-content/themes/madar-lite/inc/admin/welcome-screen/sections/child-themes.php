			...
			<div class="madar-lite-child-theme-details">
				<?php if ( 'Avada' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="https://retina-theme.com/why-you-should-choose-avada-theme/" class="button button-primary install right"><?php esc_html_e( 'Get now', 'madar-lite' ); ?></a>
			...
			<div class="madar-lite-child-theme-details">
				<?php if ( 'X WordPress Theme' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="https://retina-theme.com/x-wordpress-most-downloaded-theme/" class="button button-primary install right"><?php printf( __( 'Install %s now', 'madar-lite' ), '<span class="screen-reader-text">X WordPress Theme</span>' ); ?></a>
						<a class="button button-secondary preview right" target="_blank" href="https://retina-theme.com/x-wordpress-most-downloaded-theme/"><?php esc_html_e( 'Live Preview','madar-lite'); ?></a>
						<div class="madar-lite-clear"></div>
					</div>
				<?php } else { ?>
					<div class="theme-details active">
			...
			<div class="madar-lite-child-theme-details">
				<?php if ( 'BeTheme ' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="https://retina-theme.com/betheme-responsive-multi-purpose-wordpress-theme/" class="button button-primary install right"><?php printf( __( 'Get %s now', 'madar-lite' ), '<span class="screen-reader-text">BeTheme </span>' ); ?></a>
						<a class="button button-secondary preview right" target="_blank" href="https://retina-theme.com/betheme-responsive-multi-purpose-wordpress-theme/"><?php esc_html_e( 'Live Preview','madar-lite'); ?></a>
						<div class="madar-lite-clear"></div>
					</div>
				<?php } else { ?>
				<div class="theme-details active">
			...
			<div class="madar-lite-child-theme-details">
				<?php if ( 'Jupiter' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="https://retina-theme.com/jupiter-retina-multipurpose-wordpresstheme/" class="button button-primary install right"><?php printf( __( 'Install %s now', 'madar-lite' ), '<span class="screen-reader-text">Jupiter</span>' ); ?></a>
						<a class="button button-secondary preview right" target="_blank" href="https://retina-theme.com/jupiter-retina-multipurpose-wordpresstheme/"><?php esc_html_e( 'Live Preview','madar-lite'); ?></a>
						<div class="madar-lite-clear"></div>
					</div>
				<?php } else { ?>
				<div class="theme-details active">
